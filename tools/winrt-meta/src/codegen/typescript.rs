...
pub fn generate_collections() -> String {
    ...
    out.push_str("// Well-known WinRT generic collection interfaces\n");
    out.push_str("import { DynWinRtValue } from 'dynwinrt-js';\n\n");

    // IIterable<T>
    out.push_str("export class IIterable<T> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<T>(obj: DynWinRtValue): IIterable<T> { return new IIterable(obj); }\n");
    out.push_str("}\n\n");

    // IIterator<T>
    out.push_str("export class IIterator<T> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<T>(obj: DynWinRtValue): IIterator<T> { return new IIterator(obj); }\n");
    out.push_str("}\n\n");

    // IVectorView<T>
    out.push_str("export class IVectorView<T> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<T>(obj: DynWinRtValue): IVectorView<T> { return new IVectorView(obj); }\n");
    out.push_str("}\n\n");

    // IVector<T>
    out.push_str("export class IVector<T> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<T>(obj: DynWinRtValue): IVector<T> { return new IVector(obj); }\n");
    out.push_str("}\n\n");

    // IMapView<K, V>
    out.push_str("export class IMapView<K, V> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<K, V>(obj: DynWinRtValue): IMapView<K, V> { return new IMapView(obj); }\n");
    out.push_str("}\n\n");

    // IMap<K, V>
    out.push_str("export class IMap<K, V> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<K, V>(obj: DynWinRtValue): IMap<K, V> { return new IMap(obj); }\n");
    out.push_str("}\n\n");

    // IKeyValuePair<K, V>
    out.push_str("export class IKeyValuePair<K, V> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<K, V>(obj: DynWinRtValue): IKeyValuePair<K, V> { return new IKeyValuePair(obj); }\n");
    out.push_str("}\n\n");

    // IObservableVector<T>
    out.push_str("export class IObservableVector<T> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<T>(obj: DynWinRtValue): IObservableVector<T> { return new IObservableVector(obj); }\n");
    out.push_str("}\n\n");

    // IObservableMap<K, V>
    out.push_str("export class IObservableMap<K, V> {\n");
    out.push_str("    readonly _obj: DynWinRtValue;\n");
    out.push_str("    constructor(obj: DynWinRtValue) { this._obj = obj; }\n");
    out.push_str("    static from<K, V>(obj: DynWinRtValue): IObservableMap<K, V> { return new IObservableMap(obj); }\n");
    out.push_str("}\n");
...
fn convert_return(expr: &str, return_type: Option<&TypeMeta>, is_async: bool) -> String {
    ...
    match return_type {
        ...
        Some(TypeMeta::Parameterized { name, args, .. }) => {
            if let Some(short) = known_generic_name(name) {
                let ts_args: Vec<String> = args.iter().map(|a| ts_param_type(a)).collect();
                format!("new {}<{}>({})", short, ts_args.join(", "), expr)
            } else {
                expr.to_string()
            }
        }
...
fn ts_param_type(typ: &TypeMeta) -> String {
    match typ {
        ...
        TypeMeta::Parameterized { name, args, .. } => ts_parameterized_type(name, args),
...
fn ts_return_type(typ: Option<&TypeMeta>, is_async: bool) -> String {
    let inner = match typ {
        ...
        Some(TypeMeta::Parameterized { name, args, .. }) => {
            let s = ts_parameterized_type(name, args);
