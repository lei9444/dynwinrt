...
import { DynWinRtType, DynWinRtMethodSig, DynWinRtValue, WinGuid } from 'dynwinrt-js';
...
pub fn generate_interface(iface: &InterfaceMeta, known_types: &HashSet<String>) -> String {
    let mut out = String::new();
    out.push_str("// Generated by winrt-meta — do not edit\n");
    out.push_str("import { DynWinRtType, DynWinRtMethodSig, DynWinRtValue, WinGuid } from 'dynwinrt-js';\n");
...
fn build_method_sig(method: &MethodMeta) -> String {
    ...
    for param in &method.params {
        if param.direction == ParamDirection::Out || param.direction == ParamDirection::OutArray {
